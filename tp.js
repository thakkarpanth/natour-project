...
const data = `#include <bits/stdc++.h> 
		using namespace std;
...
`
fs.writeFileSync('cppCode.cpp' , data); 
async function logic(){
    await exec('g++ cppCode.cpp' , async (err , stdout , stderr) => {
        
        await exec('a.exe' , async (err , stdout , stderr)=> {
            console.log(stdout);
        })
